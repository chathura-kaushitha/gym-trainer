...
export default function Card({ children, title, icon: Icon, action, className = "" }) {
  return (
    <div
      className={`relative bg-gradient-to-br from-neutral-950 to-black border-2 border-neutral-900 rounded-2xl p-6 group overflow-hidden hover:border-orange-900/30 transition-all duration-300 ${className}`}
    >
